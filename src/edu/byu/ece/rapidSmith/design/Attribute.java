...
public class Attribute implements Serializable, INamed, Cloneable {
	 ...
	 */
	@JsonCreator
	public Attribute(@JsonProperty("pname") String physicalName, @JsonProperty("lname") String logicalName, @JsonProperty("value") String value){
