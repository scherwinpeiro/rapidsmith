...
public class PIP implements Comparable<Object>, Serializable, WireContainer, Cloneable{
	 ...
	 */
	@JsonProperty("dir")
	private PipDirection direction = PipDirection.DIRECTIONAL;
	...
	public PIP(){
		...
		this.startWire = -1;
		this.endWire = -1;
		this.direction = PipDirection.DIRECTIONAL;
	}
	...
	public PIP(Tile tile, int startWire, int endWire, PipDirection direction) {
		this.tile = tile;
		this.startWire = startWire;
		this.endWire = endWire;
	...
	public String toString(){
		...
		" "+direction+" " + we.getWireName(endWire);
	}
	...
	/**
	 * Get the PIP direction
	 * @return the pip direction
	 */
	public PipDirection getDirection() {
		return direction;
	}

	/**
	 * Set the PIP direction
	 * @param direction the direction to set
	 */
	public void setDirection(PipDirection direction) {
		this.direction = direction;
	}

	public PIP clone() {
		return new PIP(tile, startWire, endWire, direction);
	}
}
