...
public class StaticSourceHandler{
	...
	//================================================================
// added for Spartan6 adaption
//----------------------------------------------------------------
	private static HashMap<String, String[]> s6BounceMap;
//================================================================	
	/**
	 * Constructor
...
// added for Spartan6 adaption
//----------------------------------------------------------------
		else if(dev.getFamilyType().equals(FamilyType.SPARTAN6)){
			slicePin = "B";
		}
//================================================================
		else{
	...
	private ArrayList<Node> reserveCriticalNodes(Net net){
		...
		for(Pin p : net.getPins()){
			...
			Node reserved = tempNode.getSwitchBoxSink(dev); //,we);
...
// added for Spartan6 adaption
//----------------------------------------------------------------
	private HashMap<Tile, PinSorter> sortPinsSpartan6(ArrayList<Net> staticSourcedNets){
		HashMap<Tile, PinSorter> pinSwitchMatrixMap = new HashMap<Tile, PinSorter>();
		for(Net net : staticSourcedNets){
			for(Pin pin : net.getPins()){
...
// added for Spartan6 adaption
//----------------------------------------------------------------
	public void step3_Spartan6(HashMap<Tile, PinSorter> pinSwitchMatrixMap, HashSet<Tile> contentionTiles){
		...
		for(Tile tile : pinSwitchMatrixMap.keySet()){
			...
			for(StaticSink ss : ps.useTIEOFF){
				...
				String[] fans = s6BounceMap.get(ssWireName);
				Node newNode = null;
			...
			for(StaticSink ss : ps.attemptTIEOFF){
				if(ss.pin.getNet().getType().equals(NetType.GND)){
					String[] fans = s6BounceMap.get(we.getWireName(ss.switchMatrixSink.wire));
		...
		for(PinSorter ps : pinSwitchMatrixMap.values()){
			ssLoop : for(StaticSink ss : ps.useTIEOFF){
				...
				if((fanWireNames = s6BounceMap.get(we.getWireName(ss.switchMatrixSink.wire))) != null){
...
// added for Spartan6 adaption
//----------------------------------------------------------------						
					for(PrimitiveSite ps : net.getSourceTile().getPrimitiveSites()){

						if(ps.isCompatiblePrimitiveType(PrimitiveType.TIEOFF)){
							Instance inst = router.design.getInstanceAtPrimitiveSite(ps);

							inst.removeNet(net);
							System.out.println("removed net in Tile "+ps.getName());
						}
					}
//================================================================
...
//----------------------------------------------------------------
			case SPARTAN6:
				pinSwitchMatrixMap = sortPinsSpartan6(staticSourcedNets);
				break;
//================================================================
...
// added for Spartan6 adaption
//----------------------------------------------------------------		
		if(dev.getFamilyType().equals(FamilyType.SPARTAN6))
			step3_Spartan6(pinSwitchMatrixMap,contentionTiles);
...
//----------------------------------------------------------------
					if(dev.getFamilyType().equals(FamilyType.SPARTAN6)){
						Instance i=findSLICE_Spartan6(site, srcTypeString);
						if(i==null){}
...
// added for Spartan6 adaption
//----------------------------------------------------------------	
	private Instance findSLICE_Spartan6(PrimitiveSite site, String srcTypeString){

		if(site.getType().equals(PrimitiveType.SLICEX) || site.getType().equals(PrimitiveType.SLICEM)){
			if(!router.design.getUsedPrimitiveSites().contains(site)){
				Instance returnMe = new Instance();
				HashMap<String, Attribute> attributeMap = new HashMap<String, Attribute>();
				attributeMap.put("_NO_USER_LOGIC", new Attribute("_NO_USER_LOGIC","",""));
				...
				returnMe.place(site);
				returnMe.setType(PrimitiveType.SLICEX);
				returnMe.setAttributes(attributeMap);
				returnMe.setName("XDL_DUMMY_" + returnMe.getTile() + "_" + site.getName());
				currStaticSourcePin = null;
				return returnMe;
...
// added for Spartan6 adaption
//----------------------------------------------------------------		
		s6BounceMap=new HashMap<String,String[]>();
		s6BounceMap.put("LOGICIN_B21", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B20", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B23", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B22", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B25", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B24", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B27", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B26", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B29", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B28", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B62", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B60", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B61", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B12", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B8", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B11", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B9", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B6", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B10", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B7", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B16", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B15", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B14", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B13", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B19", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B18", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B17", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B57", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B58", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B59", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B5", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B4", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B50", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B51", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B3", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B52", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B2", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B1", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B53", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B0", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B54", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B55", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B56", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B43", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B42", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B45", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B44", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B41", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B40", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B47", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B46", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B49", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B48", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B34", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B33", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B32", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B31", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B30", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B39", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B38", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B37", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B36", new String[]{"GFAN1","GFAN0"});
		s6BounceMap.put("LOGICIN_B35", new String[]{"GFAN1","GFAN0"});
//================================================================
