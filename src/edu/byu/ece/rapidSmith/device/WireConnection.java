 ...
 * {@link Tile} ({@code HashMap<Integer,Wire[]>}) which provides all of the wire connections
 ...
 *
 */
public class WireConnection implements Serializable, Comparable<WireConnection>, WireContainer{
	...
	public String toString(){
		return this.wire +" "+ this.rowOffset +" "+ this.columnOffset + " "+ this.isPIP;
	}
