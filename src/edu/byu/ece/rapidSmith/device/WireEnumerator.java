...
public class WireEnumerator implements Serializable {
	...
	public boolean readCompactEnumFile(String fileName, FamilyType familyType){
		try {
			...
			return readCompactEnumInputStream(fis, familyType);
	...
	public boolean readCompactEnumInputStream(InputStream is, FamilyType familyType) {
	...
	public static void main(String[] args){
		...
		WireEnumerator we = DeviceDatabaseProvider.getDeviceDatabase().loadWireEnumerator(args[0]);
