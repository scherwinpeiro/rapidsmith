...
import static edu.byu.ece.rapidSmith.device.PrimitiveSite.compatibleTypesArray;
...
public enum PrimitiveType{
	...
	public PrimitiveType[] getCompatibleTypes(Device device) {
		return compatibleTypesArray[device.getFamilyType().ordinal()].get(this);
	}
}
