...
public abstract class Path {
	...
	private List<PathElement> maxDataPath = new ArrayList<PathElement>();
	 ...
	 */
	public void setMaxDataPath(List<PathElement> maxDataPath) {
		this.maxDataPath = maxDataPath;
	}
	/**
	 * @return the maxDataPath
	 */
	public List<PathElement> getMaxDataPath() {
		return maxDataPath;
	}

	public float getRoutingDelay() {
		return routingDelay;
	}

	public void setRoutingDelay(float routingDelay) {
