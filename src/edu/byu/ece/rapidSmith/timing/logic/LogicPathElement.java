...
public class LogicPathElement extends PathElement implements Serializable{
	...
	private List<String> logicalResources = new ArrayList<String>();
	 ...
	 */
	public List<String> getLogicalResources() {
		return logicalResources;
	}
	/**
	 * @param logicalResources the logicalResources to set
	 */
	public void setLogicalResources(List<String> logicalResources) {
	...
	public String getLogicalName() {
		if (getPin()!=null)
			return getPin().getNet().getName();
		else if (getLogicalResources()!=null)
			return getLogicalResources().stream().collect(Collectors.joining(" "));
		else
			return "Null";
	}
}
