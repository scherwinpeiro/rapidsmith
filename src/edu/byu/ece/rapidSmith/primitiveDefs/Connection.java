...
public class Connection implements Serializable{
	...
	private double delay = Float.POSITIVE_INFINITY;
	...
	public Element getElement0(PrimitiveDef def) {
		return def.getElement(element0);
	}

	public Element getElement1(PrimitiveDef def) {
		return def.getElement(element1);
	}

	public PrimitiveDefPin getPin0(PrimitiveDef def) {
		return def.getElement(element0).getPin(pin0);
	}

	public PrimitiveDefPin getPin1(PrimitiveDef def) {
		return def.getElement(element1).getPin(pin1);
	}
