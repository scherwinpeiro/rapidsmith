...
public class Element implements Serializable{
	...
	public Connection getConnectionTo(String element) {
		for (Connection connection : connections) {
			if (connection.getElement0().equals(element) || connection.getElement1().equals(element))
				return connection;
		}
		return null;
	}
	...
	public Connection getConnectionTo(Element element) {
		return getConnectionTo(element.getName());
	}
}
