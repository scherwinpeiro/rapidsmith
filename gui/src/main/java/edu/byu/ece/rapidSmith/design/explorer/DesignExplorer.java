...
public class DesignExplorer extends QMainWindow{
	...
	/** LogicDelayPath to images in RapidSmith */
	protected static String rsrcPath = FileDeviceDatabase.getRapidSmithPath()+File.separator+"images";
	...
	protected static final String PATH_DELAYS = "LogicDelayPath Delays";
	protected static final String PATH_OFFSETS = "LogicDelayPath Offsets";
