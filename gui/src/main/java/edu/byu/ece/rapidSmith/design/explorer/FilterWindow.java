	...
	public FilterWindow(QWidget parent, FilterType type){
        ...
        switch(type){
        	...
        	case DELAYS:
        		subViews = new QTreeView[1];
        		subViews[0] = createNewView(true);
        		proxyLayout.addWidget(new QLabel("Maximum Data LogicDelayPath"));
        		proxyLayout.addWidget(subViews[0], 3, 0, 1, 5);
        		subModels = new QStandardItemModel[1];
        	...
        	case OFFSETS:
        		...
        		subViews[1] = createNewView(true);        		
        		proxyLayout.addWidget(new QLabel("Minimum Data LogicDelayPath"));
        		proxyLayout.addWidget(subViews[1], 6, 0, 1, 5);
	...
	public void loadCurrentDesignData(){
		switch(this.type){
			...
			case DELAYS:
				...
				setHeaders(model, new String[]
				          {"Delay", "Source", "Destination", "Data LogicDelayPath Delay", "Levels of Logic"});
			...
			case OFFSETS:
				model = new QStandardItemModel(0, 7, this);
				setHeaders(model, new String[]
				          {"Offset", "Source", "Destination", "Data LogicDelayPath Delay", "Levels of Logic (Data)", "Clock LogicDelayPath Delay", "Levels of Logic (Clock)"});
